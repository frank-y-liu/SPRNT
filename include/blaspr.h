...
void FORTRAN(dcopy)(int *n, const double *dx, const int *incx, double *dy,
                    const int *incy);
...
double FORTRAN(ddot)(int *, const double *, const int *, const double *,
                     const int *);
void FORTRAN(daxpy)(int *, const double *, const double *, const int *,
                    double *, const int *);
