...
protected:
  ...
  double _get_pp(int num_now, long int *now, int num_prev, long int *prev,
                 double dy, double unit);
...
public:
  ...
  // access method, use them to get details of the x-section after calling
  // Construct
