...
C***CATEGORY NO.  C4A
C***KEYWORDS  ARC TANGENT,DOUBLE PRECISION,ELEMENTARY FUNCTION,
C             RELATIVE ERROR,TRIGONOMETRIC ARC TANGENT
C***AUTHOR  FULLERTON, W., (LANL)
C***PURPOSE  Evaluates DATAN(X) from first order relative accuracy so
...
C
      ...
      RETURN
C
 20   IF (Y.GT.XMAX) CALL XERROR ( 'D9ATN1  NO PRECISION IN ANSWER BECAU
     1SE X IS TOO BIG', 51,       2, 2)
      IF (Y.GT.XBIG) CALL XERROR ( 'D9ATN1  ANSWER LT HALF PRECISION BEC
