...
C***CATEGORY NO.  C10D
C***KEYWORDS  BAIRY FUNCTION,DOUBLE PRECISION,SPECIAL FUNCTION
C***AUTHOR  FULLERTON, W., (LANL)
C***PURPOSE  Calculates the d.p. Bairy function (Airy of second kind).
C***DESCRIPTION
C
...
C***REFERENCES  (NONE)
C***ROUTINES CALLED  D1MACH,D9AIMP,DBIE,DCSEVL,INITDS,XERROR
C***END PROLOGUE  DBI
...
C
 30   IF (X.GT.2.0D0) GO TO 40
     ...
     1  DCSEVL (Z, BIG2CS, NBIG2))
      RETURN
C
 40   IF (X.GT.XMAX) CALL XERROR ( 'DBI     X SO BIG THAT BI OVERFLOWS',
     1 34, 1, 2)
C
