...
C***CATEGORY NO.  C10D
C***KEYWORDS  AIRY FUNCTION,DOUBLE PRECISION,MODULUS,PHASE,
C             SPECIAL FUNCTION
C***AUTHOR  FULLERTON, W., (LANL)
C***PURPOSE  Evaluates the Airy modulus and phase for X .LE. -1.0
C***DESCRIPTION
C
...
C***END PROLOGUE  D9AIMP
     ...
     2  XSML, Z,  D1MACH, DCSEVL
      ...
      DATA NAM20, NATH0, NAM21, NATH21, NAM22, NATH2 / 6*0 /
      DATA XSML / 0.D0 /
C***FIRST EXECUTABLE STATEMENT  D9AIMP
      IF (NAM20.NE.0) GO TO 10
...
C
 20   IF (X.GE.(-2.0D0)) GO TO 30
      ...
      GO TO 40
C
 30   IF (X.GE.(-1.0D0)) CALL XERROR ( 'D9AIMP  X MUST BE LE -1.0', 25,
     11, 2)
C
