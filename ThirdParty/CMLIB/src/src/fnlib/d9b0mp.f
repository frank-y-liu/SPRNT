...
C***CATEGORY NO.  C10A1
C***KEYWORDS  BESSEL FUNCTION,DOUBLE PRECISION,MODULUS,PHASE,
C             SPECIAL FUNCTION
C***AUTHOR  FULLERTON, W., (LANL)
C***PURPOSE  Evaluates the d.p. modulus and phase for J0 and Y0 Bessel
C            functions.
C***DESCRIPTION
C
...
C
      XMAX = 1.0D0/D1MACH(4)
C
 10   IF (X.LT.4.D0) CALL XERROR ( 'D9B0MP  X MUST BE GE 4', 22, 1, 2)
C
      ...
      RETURN
C
 20   IF (X.GT.XMAX) CALL XERROR ( 'D9B0MP  NO PRECISION BECAUSE X IS BI
     1G', 37, 2, 2)
C
      Z = 128.D0/(X*X) - 1.D0
