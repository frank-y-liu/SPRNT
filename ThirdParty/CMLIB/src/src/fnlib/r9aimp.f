...
C***CATEGORY NO.  C10D
C***KEYWORDS  AIRY FUNCTION,MODULUS,PHASE,SPECIAL FUNCTION
...
C***END PROLOGUE  R9AIMP
      ...
      DATA NAM21, NATH1, NAM22, NATH2, XSML / 4*0, 0.0 /
C***FIRST EXECUTABLE STATEMENT  R9AIMP
      IF (NAM21.NE.0) GO TO 10
      ETA = 0.1*R1MACH(3)
...
C
 10   IF (X.GE.(-2.0)) GO TO 20
      ...
      GO TO 30
C
 20   IF (X.GT.(-1.0)) CALL XERROR ( 'R9AIMP  X MUST BE LE -1.0', 25, 1,
     1  2)
C
      Z = (16.0/X**3 + 9.0)/7.0
