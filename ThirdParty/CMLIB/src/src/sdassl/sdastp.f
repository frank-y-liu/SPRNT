      SUBROUTINE SDASTP(X,Y,YPRIME,NEQ,
...
C***REFER TO  SDASSL
C***ROUTINES CALLED  SDANRM,SDAJAC,SDASLV,SDATRP
...
415     DELTA(I) = PHI(I,K) + DELTA(I)
      ...
      IF(AMAX1(TERKM1,TERKM2).GT.TERK)GO TO 430
C     lower the order
420   CONTINUE
      KNEW=K-1
      EST = ERKM1
...
510      DELTA(I)=E(I)-PHI(I,KP2)
      ERKP1 = (1.0E0/FLOAT(K+2))*SDANRM(NEQ,DELTA,WT,RPAR,IPAR)
      TERKP1 = FLOAT(K+2)*ERKP1
      IF(K.GT.1)GO TO 520
      IF(TERKP1.GE.0.5E0*TERK)GO TO 550
      GO TO 530
520   IF(TERKM1.LE.AMIN1(TERK,TERKP1))GO TO 540
