...
C
C
      DATA ZERO,ONE,TWO,THREE,FIVE/0.0D0,1.0D0,2.0D0,3.0D0,5.0D0/
C
C
...
C
         ...
         PVPCRV = DPVB(FUN,N,NP,M,BETA,XPLUSD,LDXPD,PVTEMP,
     +                  NROW,J,STPCRV,IFLAG)
         IF (IFLAG.LT.0) THEN
            RETURN
         END IF
         PVMCRV = DPVB(FUN,N,NP,M,BETA,XPLUSD,LDXPD,PVTEMP,
     +                  NROW,J,-STPCRV,IFLAG)
         IF (IFLAG.LT.0) THEN
            RETURN
         END IF
...
C
     ...
     +             XPLUSD(NROW,J)) - XPLUSD(NROW,J)
         PVPCRV = DPVD(FUN,N,NP,M,BETA,XPLUSD,LDXPD,PVTEMP,
     +                 NROW,J,STPCRV,IFLAG)
         IF (IFLAG.LT.0) THEN
            RETURN
         END IF
         PVMCRV = DPVD(FUN,N,NP,M,BETA,XPLUSD,LDXPD,PVTEMP,
     +                 NROW,J,-STPCRV,IFLAG)
         IF (IFLAG.LT.0) THEN
            RETURN
         END IF
...
C
         CALL DJCKF(FUN,N,NP,M,XPLUSD,LDXPD,BETA,ETA,TOL,
