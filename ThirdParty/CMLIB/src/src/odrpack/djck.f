...
C***ROUTINES CALLED  DETAF,DJCKM,DSETN,DXPY
...
C
         CALL DJCKM(FUN,N,NP,M,XPLUSD,LDXPD,BETA,TYPJ,ETA,TOL,EPSMAC,
...
C
            CALL DJCKM(FUN,N,NP,M,XPLUSD,LDXPD,BETA,TYPJ,ETA,TOL,
