*DODLMW
      SUBROUTINE DODLMW
     +   (N,M,NP,
     +   JPVTI,WRK1I,TFJACI,OMEGAI,YTI,UI,QRAUXI,WRK2I)
C***BEGIN PROLOGUE  DODLMW
...
C             OPTIMIZATION GROUP/SCIENTIFIC COMPUTING DIVISION
C             NATIONAL BUREAU OF STANDARDS, BOULDER, CO 80303-3328
C***PURPOSE  GET STARTING LOCATIONS OF WORK ARRAYS NEEDED BY SUBROUTINE
C            DODLM
C***END PROLOGUE  DODLMW
C
...
C
C
C***FIRST EXECUTABLE STATEMENT  DODLMW
C
C
C  GET STARTING LOCATIONS WITHIN INTEGER WORKSPACE
C
      CALL DIWINF
     +   (M,NP,
     ...
     +   LUNERI,LUNRPI)
C
C  GET STARTING LOCATIONS WITHIN DOUBLE PRECISION WORK SPACE
C
      CALL DWINF
     +   (N,M,NP,
