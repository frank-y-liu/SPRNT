...
C
      CALL DIDTS(N,M,W,RHO,LDRHO,ALPHA,TT,LDTT,FJACX,LDFJX,VDTD,N)
      DO 20 I=1,N
...
C
      CALL DIDTS(N,M,W,RHO,LDRHO,ALPHA,TT,LDTT,DDELT,N,VDTD,N)
      DO 50 I=1,N
...
C
      CALL DIDTS(N,M,W,RHO,LDRHO,ALPHA,TT,LDTT,T,N,T,N)
C
