...
C
C  ***  VERSION OF NL2SOL THAT CALLS DNL2IT  ***
C
C  ***  PARAMETERS  ***
C
      INTEGER N, P, LIV, LV
...
C/6
      DATA D/27/, J/70/, LASTV/45/, MODE/35/, NEXTV/47/, NF0/68/,
     1     NF1/69/, NFCALL/6/, NFGCAL/7/, R/61/, RDREQ/57/, REGD/67/,
     2     TOOBIG/2/, VNEED/4/
C/7
C     PARAMETER (D=27, J=70, LASTV=45, MODE=35, NEXTV=47, NF0=68,
