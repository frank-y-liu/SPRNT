     ...
     1   MAXP1,RESULT,ABSERR,NEVAL,IER,LAST,ALIST,BLIST,RLIST,ELIST,
     2   IORD,NNLOG,MOMCOM,CHEBMO)
...
C
     ...
     1  IORD(LIMIT),RLIST2(52),RES3LA(3),CHEBMO(MAXP1,25),NNLOG(LIMIT)
C
      EXTERNAL F
C
...
C
     ...
     1  EPSREL.LT.AMAX1(0.5E+02*EPMACH,0.5E-14)).OR.ICALL.LT.1.OR.
     2  MAXP1.LT.1) IER = 6
