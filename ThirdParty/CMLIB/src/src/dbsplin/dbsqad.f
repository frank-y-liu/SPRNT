...
C
   60 CONTINUE
      CALL XERROR( ' DBSQAD,  X1 OR X2 OR BOTH DO NOT SATISFY T(K).LE.X.
     1LE.T(N+1)',  61, 2, 1)
      RETURN
   65 CONTINUE
      CALL XERROR( ' DBSQAD,  K DOES NOT SATISFY 1.LE.K.LE.20',
     1 41, 2, 1)
      RETURN
   70 CONTINUE
      CALL XERROR( ' DBSQAD,  N DOES NOT SATISFY N.GE.K', 35, 2, 1)
      RETURN
      END
