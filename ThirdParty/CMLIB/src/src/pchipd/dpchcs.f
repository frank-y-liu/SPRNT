...
C        a. Change DPCHCS to PCHCS wherever it occurs,
C        b. Change DPCHSD to PCHSD wherever it occurs,
C        c. Change DPCHST to PCHST wherever it occurs,
C        d. Change DPCHSW to PCHSW wherever it occurs,
C        e. Change all references to the Fortran intrinsics to their
C           single precision equivalents,
C        f. Change the double precision declarations to real, and
C        g. Change the constants ZERO and ONE to single precision.
C
C  DECLARE ARGUMENTS.
C
