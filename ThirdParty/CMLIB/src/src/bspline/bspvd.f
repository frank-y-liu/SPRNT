...
C
  200 CONTINUE
      CALL XERROR( ' BSPVD,  K DOES NOT SATISFY K.GE.1', 34, 2, 1)
      RETURN
  205 CONTINUE
      CALL XERROR( ' BSPVD,  NDERIV DOES NOT SATISFY 1.LE.NDERIV.LE.K',
     1 49, 2, 1)
      RETURN
  210 CONTINUE
      CALL XERROR( ' BSPVD,  LDVNIK DOES NOT SATISFY LDVNIK.GE.K',44,
     1 2, 1)
      RETURN
      END
