...
C
     ...
     3 TEMP1, TEMP2, TT, X
      ...
      SAVE N1, N2, N3, N4, M1, M2, M3, M4, N1D, N2D, N3D, N4D,
...
C
  ...
  160 CONTINUE
      ...
      TEMP2 = T*E1 - E2 + BB(1)
      CV = C - FPI12
      BI = (TEMP1*DCOS(CV)+TEMP2*DSIN(CV))/RTRX
      J = N4D
      F1 = DAA(J)
      E1 = DBB(J)
      F2 = 0.0D0
  ...
  170 CONTINUE
      ...
      TEMP2 = T*E1 - E2 + DBB(1)
      CV = C - SPI12
      DBI = (TEMP1*DCOS(CV)-TEMP2*DSIN(CV))*RTRX
      RETURN
      END
