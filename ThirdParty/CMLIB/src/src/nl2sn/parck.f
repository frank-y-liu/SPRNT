...
C
     ...
     4     VM(22)/0.E+0/, VM(23)/0.E+0/, VM(27)/1.01E+0/,
...
C
 ...
 10      FORMAT(/39H THE FIRST PARAMETER TO DEFLT SHOULD BE,I3,
...
C
 ...
 110  M = 0
     ...
     1                                    VM(I), VX(I)
 120          FORMAT(/6H ///  ,2A4,5H.. V(,I2,3H) =,E11.3,7H SHOULD,
...
C
 ...
 170     FORMAT(/8H ///  D(,I3,3H) =,E11.3,19H SHOULD BE POSITIVE)
 180     CONTINUE
...
C
 ...
 260          FORMAT(1X,2A4,5H.. V(,I2,3H) =,E15.7)
 270     K = K + 1
         L = L + 1
         I = I + 1
         IF (I .EQ. J) I = IJMP
...
C
      IV(DTYPE0) = IV(DTYPE)
      PARSV1 = IV(PARSAV)
      CALL SCOPY(IV(NVDFLT), V(EPSLON),1,V(PARSV1),1)
      GO TO 999
C
 290  IV(1) = 15
      IF (PU .EQ. 0) GO TO 999
