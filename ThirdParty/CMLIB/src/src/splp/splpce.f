...
C     /REAL (12 BLANKS)/DOUBLE PRECISION/,/ABS(/DABS(/,/AMAX1/
C     DMAX1/,/SASUM/DASUM/,/SCOPY/,DCOPY/.
C
...
20017 IF ((N20016-I).LT.0) GO TO 20018
      ERD(I)=AMAX1(ABS(WW(I)-ONE),EPS)*TUNE
C
...
C     A REDECOMPOSITION HAS OCCURED.
...
20031 IF (.NOT.(PAGEPL)) GO TO 20033
      ...
      IL1=IPLOC(ILOW,AMAT,IMAT)
20036 CONTINUE
20037 IPAGE=IABS(IMAT(LMX-1))
      GO TO 20034
20033 IL1=IHI+1
20034 IHI=IMAT(J+4)-(ILOW-IL1)
20039 IU1=MIN0(LMX-2,IHI)
      IF (.NOT.(IL1.GT.IU1)) GO TO 20041
      GO TO 20040
20041 CONTINUE
20042 DO 20 I=IL1,IU1
...
20062 IF ((N20061-I).LT.0) GO TO 20063
      ERP(I)=AMAX1(ABS(WW(I)-ONE),EPS)*TUNE
C
C     SYSTEM BECOMES SINGULAR WHEN ACCURACY OF SOLUTION IS .GT. FACTOR.
C     THIS VALUE (FACTOR) MIGHT NEED TO BE CHANGED.
