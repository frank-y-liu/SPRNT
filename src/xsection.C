...
inline double R_XSection::GetDepthdA(double a) { return 1.0 / _b0; }

inline double R_XSection::GetWidth(double a) { return _b0; }

inline double R_XSection::GetCentroid(double a) { return 0.5 * a * a / _b0; }

inline double R_XSection::GetCentroiddA(double a) { return a / _b0; }
...
double T_XSection::GetEqFrictiondA(double a) {
  ...
  double ef = tt * cbrt(tt / a) / (a * a);
  double efda = ef * ((4.0 / 3.0) * sp1q / (_s * sqdd * (2 * sp1q * dd + _b0)) -
                      (7.0 / 3.0) / a);
...
void T_XSection::GetEqFriction(double a, double &ef, double &efda) {
  ...
  double tt = (2 * sp1q * dd + _b0);
  ef = tt * cbrt(tt / a) / (a * a);
  efda = ef * ((4.0 / 3.0) * sp1q / (_s * sqdd * (2 * sp1q * dd + _b0)) -
               (7.0 / 3.0) / a);
}
