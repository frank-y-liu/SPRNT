...
BLAS = -L${BLAS_HOME} -lblas -L/usr/local/gfortran/lib -lgfortran
else
...
#    	-Wredundant-decls -Wnested-externs -Wdisabled-optimization -ansi
CFLAGS = -O3 -fexceptions -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -m64 -fPIC
# CFLAGS = -O3
